...
const inputChange=()=>{
  ...
  return (
    <div className='Navbar'>
        <header>
    <a href="/E-moji/" className='logo'>E-moji</a>
    ...
    <nav style={(icons)?{display:"none"}:{display:"block"}} >
        ...
        <ul>
            <li><button className={active==="All"?"active":""} onClick={()=>{prop.changeCatagory("general"); setActive("All");}}>All</button></li>
            <li><button className={active==="Smi"?"active":""} onClick={()=>{prop.changeCatagory("Smileys & Emotion"); setActive("Smi");} }>Smileys</button></li>
            <li><button className={active==="Peo"?"active":""} onClick={()=>{prop.changeCatagory("People & Body"); setActive("Peo");}}>People</button></li>
            <li><button className={active==="Ani"?"active":""} onClick={()=>{prop.changeCatagory("Animals & Nature"); setActive("Ani");}}>Animals</button></li>
            <li><button className={active==="Foo"?"active":""} onClick={()=>{prop.changeCatagory("Food & Drink"); setActive("Foo");}}>Food</button></li>
            <li><button className={active==="Tra"?"active":""} onClick={()=>{prop.changeCatagory("Travel & Places"); setActive("Tra");}}>Places</button></li>
            <li><button className={active==="Act"?"active":""} onClick={()=>{prop.changeCatagory("Activities"); setActive("Act");}}>Activities</button></li>
            <li><button className={active==="Obj"?"active":""} onClick={()=>{prop.changeCatagory("Objects"); setActive("Obj");}}>Objects</button></li>
            <li><button className={active==="oth"?"active":""} onClick={()=>{prop.changeCatagory("others"); setActive("oth");}}>Others</button></li>
        </ul>
    </nav>
